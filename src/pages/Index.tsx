...
const SERVICES = [
  { n: '01', title: 'Логотип и знак', desc: 'Уникальный, запоминающийся знак, который работает в любом масштабе.', icon: 'PenTool' },
  { n: '02', title: 'Фирменный стиль', desc: 'Единый язык бренда: цвета, шрифты, паттерны и правила применения.', icon: 'Palette' },
  { n: '03', title: 'Дизайн упаковки', desc: 'Упаковка, которая выделяется на полке и продаёт продукт.', icon: 'Package' },
];
